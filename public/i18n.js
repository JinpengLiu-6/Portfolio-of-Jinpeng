...
(function () {
  ...
  const dict = {
    ...
    zh: {
      ...
      "assistant.status.live": "实时 AI",
      "assistant.status.local": "作品集知识库",
      "assistant.hello": "你好，我是 Jinpeng 的招聘助手。你可以询问他的经历、项目、技术栈或可用时间。",
      "assistant.placeholder": "询问 Jinpeng...",
      "assistant.fallback": "Jinpeng 是一名具备 HCI 背景的产品型前端工程师，熟悉 React/TypeScript 前端和 Java/Python 后端，2026年9月12日起可开始工作。可通过 jp.liu87@gmail.com 联系他。",
      "assistant.unsure": "我可以根据作品集资料回答项目、经历、技术栈、可用时间和联系方式相关问题。",
      ...
      "terminal.helpTitle": "可用命令：",
      "terminal.help.whoami": "Jinpeng 是谁",
      "terminal.help.ls": "列出所有模块",
      "terminal.help.open": "打开模块，例如 open projects 或 open ai",
      "terminal.help.experience": "职业经历",
      "terminal.help.projects": "产品案例",
      "terminal.help.skills": "技术技能",
      "terminal.help.mission": "产品使命",
      "terminal.help.strengths": "核心优势",
      "terminal.help.focus": "当前关注方向",
      "terminal.help.why": "为什么选择 Jinpeng",
      "terminal.help.contact": "联系方式",
      "terminal.help.status": "可用时间",
      "terminal.help.clear": "清空终端",
      "terminal.whoami.identity": "身份",
      "terminal.whoami.focus": "方向",
      "terminal.whoami.latest": "最近经历",
      "terminal.whoami.stack": "技术栈",
      "terminal.whoami.available": "可开始",
      "terminal.notFound": "未找到文件：",
      "terminal.focusTitle": "当前关注方向：",
      "terminal.launching": "正在打开",
      "terminal.noModule": "没有这个模块",
      "terminal.try": "可以尝试：",
      "terminal.availableFrom": "可从",
      "terminal.sudo": "尝试得不错。Jinpeng 拥有 root 权限，访客拥有读取权限。",
      "terminal.hello": "你好。可以输入 'whoami'、'open projects' 或 'open ai'。",
      "terminal.commandNotFound": "未找到命令：",
      "terminal.typeHelp": "输入 'help' 查看可用命令。",
